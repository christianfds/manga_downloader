...
class Manga():
    ...
    def __init__(self, title: str, link: str, description: str = '', alternative_title: typing.Union[typing.List[str], str] = '', manga_id: str = '') -> None:
        self.title = title
        self.link = link
        ...
        if isinstance(alternative_title, list):
            ...
            self.alternative_title = [title for title in alternative_title.split(',') if title]
